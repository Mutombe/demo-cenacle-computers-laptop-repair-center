...
const siteData = {
  business: {
    name: "Cenacle Computers. Laptop Repair Center",
    legalName: "Cenacle Computers. Laptop Repair Center",
    tagline: "Expert Laptop Repair & IT Services",
    description: "Cenacle Computers is Harare's specialist laptop repair centre. From screen replacements and motherboard diagnostics to data recovery and IT consulting, we bring dead machines back to life.",
    phone: "+263 77 480 4019",
    phoneRaw: "+263774804019",
    whatsappNumber: "263774804019",
    email: "info@cenaclecomputers.co.zw",
    address: "eastgate market shop B29, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 4.4,
    ratingRounded: 4,
    ...
    cookieConsentKey: "cenacle-computers-laptop-repair-center-cookie-consent",
    socialLinks: {
      facebook: "#",
      instagram: "#",
      linkedin: "#",
  ...
  navbar: {
    logoImage: null,
    logoLine1: "Cenacle",
    logoLine2: "Computers. Laptop",
  },

  hero: {
    badge: "Harare's Specialist Laptop Repair Centre",
    titleParts: [
      { text: "WE BRING" },
      { text: "DEAD TECH", highlight: true },
      { text: "BACK TO LIFE." },
    ],
    subtitle: "Cenacle Computers is Harare's specialist laptop repair centre. From screen replacements and motherboard diagnostics to data recovery and IT consulting, we bring dead machines back to life.",
    ctaPrimary: "Book a Repair",
    ctaSecondary: "Our Services",
    trustBadge: "3000+ Clients Served",
    backgroundImages: [
  ...
  homeTestimonials: [
    { text: "Cenacle Computers. Laptop Repair Center fixed our entire network in one day. We had been struggling with connectivity issues for months and they diagnosed and resolved everything in a single visit.", name: "Tendai Moyo", role: "IT Manager, Corporate Client", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "The software Cenacle Computers. Laptop Repair Center built for us replaced three separate systems. It is faster, cleaner, and our staff actually enjoy using it. Best IT investment we have made.", name: "Grace Chipunza", role: "CEO, SME Business", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "After a ransomware scare, Cenacle Computers. Laptop Repair Center secured our entire infrastructure. Their cybersecurity audit was thorough and their recommendations were practical, not paranoid.", name: "Robert Manyame", role: "Finance Director, Bank", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
    { text: "We outsourced our entire IT support to Cenacle Computers. Laptop Repair Center and have not looked back. Response times are excellent and they actually explain things in language we understand.", name: "Farai Chisango", role: "Office Manager, Law Firm", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
  ],
  ...
  about: {
    ...
    team: [
      { name: "Team Leader", role: "Director", bio: "Leading Cenacle Computers. Laptop Repair Center with expertise and vision.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
  ...
  reviews: {
    ...
    items: [
      { text: "Cenacle Computers. Laptop Repair Center fixed our entire network in one day. We had been struggling with connectivity issues for months and they diagnosed and resolved everything in a single visit.", name: "Tendai Moyo", role: "IT Manager, Corporate Client", rating: 5 },
      { text: "The software Cenacle Computers. Laptop Repair Center built for us replaced three separate systems. It is faster, cleaner, and our staff actually enjoy using it. Best IT investment we have made.", name: "Grace Chipunza", role: "CEO, SME Business", rating: 5 },
      { text: "After a ransomware scare, Cenacle Computers. Laptop Repair Center secured our entire infrastructure. Their cybersecurity audit was thorough and their recommendations were practical, not paranoid.", name: "Robert Manyame", role: "Finance Director, Bank", rating: 5 },
      { text: "We outsourced our entire IT support to Cenacle Computers. Laptop Repair Center and have not looked back. Response times are excellent and they actually explain things in language we understand.", name: "Farai Chisango", role: "Office Manager, Law Firm", rating: 5 },
      { text: "Excellent hardware supply and setup. Cenacle Computers. Laptop Repair Center configured 20 new workstations for our office and everything worked perfectly from day one.", name: "Patricia Mhizha", role: "Office Manager", rating: 5 },
      { text: "Data recovery heroes! I thought my thesis was gone forever but Cenacle Computers. Laptop Repair Center recovered everything from my crashed hard drive.", name: "Simba Karonga", role: "University Student", rating: 5 },
      { text: "Cenacle Computers. Laptop Repair Center set up our cloud backup and now I sleep at night knowing our data is safe. Should have done this years ago.", name: "Douglas Chirume", role: "Business Owner", rating: 5 },
      { text: "Responsive and knowledgeable. Cenacle Computers. Laptop Repair Center is on speed dial for every tech issue and they never let us down.", name: "Linda Masuku", role: "HR Director", rating: 5 },
      { text: "The website Cenacle Computers. Laptop Repair Center built for us generates more leads than our previous three marketing campaigns combined.", name: "Patrick Makoni", role: "Marketing Manager", rating: 5 },
      { text: "Excellent pricing and no surprises on the invoice. Cenacle Computers. Laptop Repair Center quoted fairly and delivered exactly what was promised.", name: "Angela Mhembere", role: "Finance Manager", rating: 5 },
    ],
  },
  ...
  contact: {
    ...
    branches: [
      { name: "Main Office", address: "eastgate market shop B29, Harare, Zimbabwe", phone: "+263 77 480 4019", email: "info@cenaclecomputers.co.zw" },
    ],
  },

  homeCta: {
    title: "YOUR DEVICE, OUR EXPERTISE",
    subtitle: "Cenacle Computers is Harare's specialist laptop repair centre. From screen replacements and motherboard diagnostics to data recovery and IT consulting, we bring dead machines back to life.",
    ctaPrimary: "Book a Repair",
    ctaSecondary: "Chat on WhatsApp",
    whatsappText: "Hello Cenacle! I have a device that needs repair.",
    backgroundImage: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1920&q=85",
  },

  footer: {
    description: "Cenacle Computers is Harare's specialist laptop repair centre. From screen replacements and motherboard diagnostics to d...",
    copyright: "Cenacle Computers. Laptop Repair Center",
  },
};
