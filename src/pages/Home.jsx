    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
        ...
        {heroImages.map((_, i) => (
          <button
            ...
            className={`w-[3px] transition-all duration-700 ${
              i === currentSlide ? 'h-10 bg-blue-500' : 'h-4 bg-white/20 hover:bg-white/40'
            }`}
      ...
      >
        ...
        <motion.p
          ...
          className="text-blue-400 text-xs sm:text-sm font-semibold uppercase tracking-[0.3em] mb-8"
        ...
        <div className="overflow-hidden">
          {['WE BRING', 'DEAD TECH', 'BACK TO LIFE.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                className={`font-heading leading-[0.92] tracking-tight ${
                  line === 'DEAD TECH'
                    ? 'bg-gradient-to-r from-blue-500 via-blue-400 to-emerald-500 bg-clip-text text-transparent italic'
                    : 'text-white'
                }`}
                style={{
                  fontSize: 'clamp(2.2rem, 7vw, 4.5rem)',
                  fontWeight: line === 'DEAD TECH' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            3000+ Repairs &middot; 8 Years &middot; Same-Day Service
          </p>
        </motion.div>
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-blue-600 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-blue-500 hover:shadow-xl hover:shadow-blue-500/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
          ...
          <Link
            to="/projects"
            className="group inline-flex items-center gap-3 border border-white/20 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:border-blue-500/50 hover:text-blue-400 hover:bg-white/5"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaSecondary}
          </Link>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Cenacle Computers. Laptop Repair Center &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['SOFTWARE', 'NETWORKS', 'CYBERSECURITY', 'CLOUD', 'HARDWARE', 'IT SUPPORT'];
      ...
      <div className="animate-marquee flex whitespace-nowrap">
        {repeated.map((item, i) => (
          <span key={i} className="flex items-center gap-6 sm:gap-8 mx-6 sm:mx-8">
            <span className="text-blue-500/80 font-heading text-lg sm:text-2xl italic tracking-wider">
              {item}
            </span>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-blue-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>What We Do</p>
            ...
            <Link
              to="/services"
              className="group text-white/30 text-xs uppercase tracking-[0.2em] flex items-center gap-2 hover:text-blue-500 transition-colors"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
              All Services
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-5 z-10">
                    <span className="text-blue-500/15 font-heading text-6xl sm:text-7xl italic leading-none">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>

                  <div className="absolute top-5 left-5 z-10 w-10 h-10 border border-blue-500/30 flex items-center justify-center bg-navy-950/60 backdrop-blur-sm group-hover:bg-blue-500/20 group-hover:border-blue-500/60 transition-all duration-500">
                    <IconComp size={18} weight="light" className="text-blue-500" />
                  </div>
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[2px] bg-blue-500 mb-6" />
            <p className="text-blue-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Selected Works</p>
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute top-5 left-5 z-10">
                  <span className="bg-blue-600/90 text-white text-[10px] uppercase tracking-[0.2em] px-3 py-1.5 font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>
                    {project.category}
                  </span>
                </div>
              </div>
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-20 sm:py-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-16">
          {stats.map((stat, i) => (
            ...
            >
              <div
                className="font-heading text-blue-500 leading-none italic"
    ...
    <section ref={ref} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="w-12 h-[2px] bg-blue-500 mb-6" />
            <p className="text-blue-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Story</p>
            <h2 className="font-heading text-white leading-[0.95] italic mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              The Cenacle<br />
              <span className="text-blue-500">Story</span>
            </h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Cenacle Computers was born out of frustration -- too many repair shops in Harare were misdiagnosing faults and overcharging clients. We set out to build a repair centre where honesty and technical skill come first.
            </p>
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Eight years and over 3,000 successful repairs later, we have earned a reputation as the place Harare brings its most difficult laptop problems. If it can be fixed, Cenacle fixes it.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-blue-500 font-heading text-3xl sm:text-4xl italic leading-none">2016</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-blue-500 font-heading text-3xl sm:text-4xl italic leading-none">3000+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Served</div>
              </div>
              <div>
                <div className="text-blue-500 font-heading text-3xl sm:text-4xl italic leading-none">8+</div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Cenacle Computers. Laptop Repair Center"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Cenacle Computers. Laptop Repair Center team"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Certified Expertise', desc: 'Our team holds industry certifications and stays current with the latest technologies.' },
    { title: 'Rapid Response', desc: 'IT emergencies cannot wait. We guarantee fast response times for critical issues.' },
    { title: 'Transparent Pricing', desc: 'No hidden fees. Clear quotes before work begins, honest invoices when it is done.' },
    { title: 'Long-Term Partnership', desc: 'We do not just fix problems -- we become your technology partner for growth.' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-blue-500">Cenacle</span>
            </h2>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col items-center gap-3">
                {t.avatar && (
                  <img src={t.avatar} alt={t.name} className="w-12 h-12 rounded-full object-cover object-center border-2 border-blue-500/30" loading="lazy" />
                )}
                ...
                <div className="flex items-center gap-0.5 mt-1">
                  {[...Array(t.rating)].map((_, i) => (
                    <Star key={i} size={12} weight="fill" className="text-blue-500" />
                  ))}
                </div>
              </div>
            </motion.div>
          ...
          <div className="flex items-center justify-center gap-6 mt-12">
            <button onClick={prev} className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-blue-500 hover:border-blue-500/30 transition-colors duration-300" aria-label="Previous testimonial">
              <CaretLeft size={16} />
            </button>
            <div className="flex gap-2">
              {homeTestimonials.map((_, i) => (
                <button key={i} onClick={() => setActive(i)} className={`h-[2px] transition-all duration-500 ${i === active ? 'w-10 bg-blue-500' : 'w-3 bg-white/10 hover:bg-white/25'}`} aria-label={`Go to testimonial ${i + 1}`} />
              ))}
            </div>
            <button onClick={next} className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-blue-500 hover:border-blue-500/30 transition-colors duration-300" aria-label="Next testimonial">
              <CaretRight size={16} />
            </button>
          </div>
        </motion.div>
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={homeCta.backgroundImage} alt="Cenacle Computers. Laptop Repair Center" className="w-full h-[130%] object-cover object-center" loading="lazy" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 1 }}>
          ...
          <h2 className="font-heading text-white leading-[0.92] italic mb-8" style={{ fontSize: 'clamp(2.5rem, 8vw, 6rem)' }}>
            YOUR DEVICE<br />
            <span className="text-blue-500">OUR EXPERTISE</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/contact" className="group relative inline-flex items-center gap-3 bg-blue-600 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-blue-500 hover:shadow-xl hover:shadow-blue-500/25" style={{ fontFamily: 'var(--font-sans)' }}>
              {homeCta.ctaPrimary}
              <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
            </Link>
            <a href={`https://wa.me/${business.whatsappNumber}?text=${encodeURIComponent(homeCta.whatsappText)}`} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 border border-blue-500/40 text-blue-400 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-blue-500/10 hover:border-blue-500/60" style={{ fontFamily: 'var(--font-sans)' }}>
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-6 text-xs text-white/25 uppercase tracking-[0.15em]" style={{ fontFamily: 'var(--font-sans)' }}>
            <a href={`tel:${business.phoneRaw}`} className="flex items-center gap-2 hover:text-blue-500 transition-colors">
              <Phone size={14} /> {business.phone}
            </a>
            <span className="hidden sm:inline text-white/10">|</span>
            <a href={`mailto:${business.email}`} className="hover:text-blue-500 transition-colors">{business.email}</a>
            <span className="hidden sm:inline text-white/10">|</span>
